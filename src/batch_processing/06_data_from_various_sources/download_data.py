"""Download the hotels dataset from Kaggle.

Dataset:
    mykhailozub/500-hotels-from-airbnb-booking-and-hotelscom
    (referenced by the task as "hotels from Airbnb, Booking, and Hotels.com")
...
DATASET = "mykhailozub/500-hotels-from-airbnb-booking-and-hotelscom"
