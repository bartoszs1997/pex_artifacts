"""Download the Fraudulent Transactions Prediction dataset from Kaggle.

Dataset:
    vardhansiramdasu/fraudulent-transactions-prediction
    (referenced by the task as "Fraudulent Transactions Predictions")
